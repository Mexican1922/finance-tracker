        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="space-y-8">
            ...
            <p className="text-white/70 text-lg max-w-md leading-relaxed">
              Join thousands who have transformed their money habits with smart
              tracking, beautiful analytics, and goal-driven savings.
            </p>
        ...
        <div className="w-full max-w-md">
          ...
          <form className="space-y-4" onSubmit={handleEmailSignUp}>
            <div className="relative">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-foreground/40" />
              <input
                type="text"
                value={name}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="group flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 py-3.5 font-medium text-white transition-all hover:shadow-lg hover:shadow-purple-500/25 active:scale-[0.98] disabled:opacity-50 cursor-pointer"
            >
              Create Account
